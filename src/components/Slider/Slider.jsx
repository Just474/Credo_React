...
export default function Slider(){
    ...
    const slides = [{
        ...
        content: "Более 10 лет мы успешно занимаемся комплексной автоматизацией всех сфер учета предприятий, оказываем бухгалтерские и юридические услуги, а также занимаемся продажей программного обеспечения и техническим обслуживанием компьютерной техники.",
        image_path: image
    },
        {
            title: "lorem Ipsum",
